...
Outputs
-------
- data/nba/derived/nba_team_3pt_recent.json
- data/nba/derived/nba_team_3pt_recent.csv
"""
...
GAMES_JOINED = SCHEDULE_JOINED_PATH

OUT_JSON = DERIVED_DIR / "nba_team_3pt_recent.json"
OUT_CSV = DERIVED_DIR / "nba_team_3pt_recent.csv"
...
def main():
    ...
    if not rows:
        print("[INFO] No team 3PT data produced.")
        return
    ...
    print(f"[OK] Team 3PT rows written: {len(rows)}")
