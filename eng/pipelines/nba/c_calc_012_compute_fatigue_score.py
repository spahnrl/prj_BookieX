...
Reads:
  data/nba/derived/nba_games_with_b2b.json

Writes:
  data/nba/derived/nba_games_with_fatigue.json
  data/nba/derived/nba_games_with_fatigue.csv
"""
...
INPUT_PATH = DERIVED_DIR / "nba_games_with_b2b.json"
