"""
a_data_static_001_build_ncaam_team_map_from_ncaa.py
...
- a_data_static_000_ncaam_team_map.py remains the loader/publisher
"""
...
OUTPUT_JSON = Path("data/static/ncaam_team_map.json")
OUTPUT_CSV = Path("data/static/ncaam_team_map.csv")
